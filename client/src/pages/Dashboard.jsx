      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="luxury-card">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link to="/quotations" className="text-gold-600 hover:text-gold-700 font-montserrat text-sm">
                View All →
              </Link>
            </div>
          ...
          <div className="luxury-card">
            ...
            <div className="mt-6 p-4 bg-gold-50 dark:bg-charcoal-800 rounded border border-gold-200 dark:border-charcoal-700">
              <p className="font-montserrat text-sm text-charcoal-700 dark:text-charcoal-300">
                <span className="font-semibold">Tip:</span> Use keyboard shortcuts to quickly create new documents.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="font-montserrat text-charcoal-600 dark:text-charcoal-400">
            <span className="text-gold-600 font-semibold">The Patil Photography & Film's</span> • Crafting
            beautiful moments, flawlessly documented
          </p>
        </div>
      </main>
    </div>
